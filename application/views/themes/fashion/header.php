...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="<?php echo base_url(); ?>"><img style="width: 100%; max-width: 200px; max-height: 50px" src="<?=base_url('assets/uploads/sites/logo.png');?>" alt="<?php echo get_store_name(); ?>"></a>
