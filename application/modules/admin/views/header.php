       ...
       <div class="navbar-inner">
         ...
         <div class="collapse navbar-collapse" id="sidenav-collapse-main">
           ...
           <ul class="navbar-nav">
            ...
            ?>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('admin/laporanpenjualan'); ?>">
            ...
            <?php endif;?>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('admin/laporanpelanggan'); ?>">
                <i class="fa fa-file-invoice text-info"></i>
                <span class="nav-link-text">Laporan Pelanggan</span>
              </a>
            </li>
            <li class="nav-item">
